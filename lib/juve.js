...
module.exports = function (url, asserts, callback) {
  var assertions = asserts || {};
  var o = assertions.options || {};
  var phantomas = o.adapter || require('phantomas');
  var trialCount = o.trials || 3;
  var cachedTrials = [];
  ...
  // than three trials.
  var olympicScoring = (trialCount < 3 ? false : (o.olympic || false));
  
  // Convert config properties into CLI-friendly arguments
  var config = parseArguments( o.config );
